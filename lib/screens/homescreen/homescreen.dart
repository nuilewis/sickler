...
//DateTime? lastWaterLogTime = Provider.of<WaterData>(context).totalWaterTodayList.last.time;
    ...
    return Consumer5<SUserData, WaterData, HbData, OxygenData, MedsData> (
      builder: ((context, userData, waterData, hbData, oxygenData, medsData, child) {
        return  Scaffold(
                ...
                Row(
                  ...
                  children: [
                    StatsCard(
                      ...
                      statsTitle: "Water",
                      statsValue: ((waterData.totalWaterDrankToday.toDouble())/1000).toStringAsFixed(1), //to convert from ml to litres
                      statsUnit: "Litres",
                      statsTimestamp: TimeOfDay.fromDateTime(waterData.totalWaterTodayList.last.time).toString(),
                      colour: kBlue,
                      bgColour: kBlue20,
                      onPressed: () {
                    ...
                    StatsCard(
                      ...
                      statsTitle: "Hb",
                      statsValue: hbData.totalHbList.last.value.toStringAsFixed(1),
                      statsUnit: "g/dl",
                      statsTimestamp: TimeOfDay.fromDateTime(hbData.totalHbList.last.time).toString(),
                      colour: kFuchsia,
                      bgColour: kFuchsia20,
                      onPressed: () {
                        HapticFeedback.lightImpact();
                ...
                Row(
                  ...
                  children: [
                    StatsCard(
                      ...
                      statsTitle: "Oxygen",
                      statsValue: oxygenData.totalOxygenList.last.value.toString(),
                      statsUnit: "%",
                      statsTimestamp: TimeOfDay.fromDateTime(oxygenData.totalOxygenList.last.time).toString(),
                      colour: kOrange,
                      bgColour: kOrange20,
                      onPressed: () {
                        HapticFeedback.lightImpact();
                    ...
                    StatsCard(
                      ...
                      statsTitle: "Meds",
                      statsValue: TimeOfDay.fromDateTime(medsData.medsList.last.time.last).toString(),
                      statsUnit: "pm",
